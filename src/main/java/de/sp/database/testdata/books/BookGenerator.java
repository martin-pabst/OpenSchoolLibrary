        ...
        for (String className : classNames) {
            ...
            for (BorrowerRecord br : studentMap.get(className)) {
                ...
                for (NeededBookRecord neededBook : neededBooks) {
                    ...
                    BookCopy bookCopy = BookCopyDAO.insert(neededBook.getBook_id(), "1", "" + barcode++, con);

                    if (borrowBooks) {
                        Borrows borrows = BorrowsDAO.insert(bookCopy.getId(), br.getStudent_id(), null, now, null, null, "Generated by BookGenerator", con);
                    }
