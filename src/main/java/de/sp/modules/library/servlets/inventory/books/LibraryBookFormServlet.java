...
public class LibraryBookFormServlet extends BaseGridServlet<Object> {
    ...
    private void update(Long school_id, Connection con, String key,
        ...
        switch (key) {
            case "form":
                ...
                ValueListStore.getInstance().validateID(ValueListType.form, school_id, formID, true);
            ...
            case "curriculum":
                ...
                ValueListStore.getInstance().validateID(ValueListType.form, school_id, curriculumID, true);
            ...
            case "languageyear":
                ...
                if (value != null && !value.toString().isEmpty()) {
                    ...
                    if(languageyear < 1 || languageyear > 10){
                        throw new ValidationException("Languageyear " + languageyear + " is not realistic.");
                    }
                }
    ...
    protected GridResponseSave doSave(GridRequestSave requestData,
        ...
        if(languageyear != null && (languageyear < 1 || languageyear > 10)){
            throw new ValidationException("Languageyear " + languageyear + " is not realistic.");
        }
        ...
        Long school_id = requestData.getSchool_id();
        ...
        ValueListStore.getInstance().validateID(ValueListType.form, school_id, form_id, true);
        ValueListStore.getInstance().validateID(ValueListType.curriculum, school_id, curriculum_id, true);
