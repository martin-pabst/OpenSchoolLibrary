...
abstract public class BaseReport {
    ...
    protected void beginHtmlTable(String style){
        html.append("<table style=\"" + style + "\">\n");
    }
    ...
    protected void beginHtmlCell(String style){
        html.append("<td style=\"" + style + "\">");
    }

    protected void beginHtmlCell(int colspan, String style){
